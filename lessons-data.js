    ...
    steps: [
      {
        ...
        samplePrompt: `Chọn 1 trong 4 IDE — cái nào anh/chị thấy hợp thì dùng:

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🅰 GOOGLE ANTIGRAVITY (Đề xuất cho người mới, non-tech)
   • Vào antigravity.google → tải về → cài như app thông thường
   • Login bằng Google (gmail nào cũng được) — free, không cần thẻ tín dụng
...
🅱 VSCode + GITHUB COPILOT CHAT
   ...
   • (Lưu ý: Bản free có giới hạn, nếu hết quota thì chuyển qua tuỳ chọn C hoặc D)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🅲 CURSOR (Giao diện giống VSCode, bản free hào phóng hơn)
   • Tải từ cursor.com → cài đặt
   • Login Google/GitHub → được 14 ngày dùng bản Pro, sau đó về bản free
   • Bấm tổ hợp Ctrl+L → ô chat hiện ra
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🅳 VSCode + CLINE (Free hoàn toàn, nhưng cần tự setup API key)
   • Tải VSCode → mở tab Extensions → tìm "Cline" → Install
   • Cline cần anh/chị có API key của Anthropic / OpenAI / Gemini (có tier free)
...
- Anh Lân sẽ trực tiếp audit các evidence này trong vòng 48h để chốt kết quả Pass/Fail/Borderline.`,
  ...
  5: {
    ...
    prereqWarning: '⚠ Buổi này bắt buộc sử dụng tài khoản Claude Code Max ($100/tháng) vì các giao thức kết nối MCP (Model Context Protocol) yêu cầu hạ tầng cloud mạnh. Bản Pro $20 không thể đáp ứng được tác vụ này.',
    hints: [
...
⚠ Lưu ý: Bắt buộc chọn Use case mới (như Payroll, Onboarding, C&B, L&D...), cấm sao chép kịch bản Recruiter Agent (Buổi 1-5).`,
  ...
  6: {
    ...
    prereqWarning: '⚠ Buổi này bắt buộc sử dụng tài khoản Claude Code Max ($100/tháng) để có thể xử lý đa luồng (Multi-session) cùng lúc. Hạ tầng của gói Pro $20 không đủ sức tải bài toán này.',
    layers: [
...
KHÔNG bắt 80% tuyệt đối — đo improvement quan trọng hơn con số tuyệt đối.`,
  ...
  8: {
    ...
    prereqWarning: '⚠ Buổi thực hành này yêu cầu tài khoản Claude Max ($100/tháng) cộng với việc thiết lập một không gian lưu trữ URL Public (Có thể dùng các dịch vụ miễn phí như Netlify hoặc Vercel).',
    layers: [
