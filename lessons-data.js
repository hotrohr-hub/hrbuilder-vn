    ...
    steps: [
      {
        ...
        desc: 'Folder .claude/skills/ với SKILL.md + rubric + brand-voice + format. Cái này máy tạo giúp, bạn chỉ ngồi duyệt.',
        sampleType: 'prompt',
...
Tạo xong: in cây folder + show 3 file đầu tiên cho tôi review.`,
      ...
      {
        title: 'Điền brand voice công ty bạn', xp: 50,
        desc: 'Tone, từ cấm dùng, phúc lợi mặc định, format JD bắt buộc. Đây là phần CHỈ bạn biết, máy đoán không nổi.',
        sampleType: 'prompt',
...
1. [Vị trí gốc của bạn — vd: HR Executive]
...
Nếu lệch ở vị trí 2/3 → quay lại brand-voice/SKILL.md viết rõ hơn.`,
      ...
      },
      {
        ...
        desc: 'Repo private. Đồng nghiệp clone, chạy, ghi nhận trải nghiệm. Đây là khoảnh khắc bạn nhân bản được mình.',
        sampleType: 'instruction',
...
2. Gửi cho họ: link repo + 5 phút screencast bạn chạy /screen-cv
...
Đính file FEEDBACK-[ten-dong-nghiep].md vào repo — đây là evidence để Lan chấm.`,
  ...
  4: {
    ...
    prereqWarning: '⚠ Buổi này bạn cần chọn 1 trong 2 path: (a) Claude Code Max ($100/tháng) chạy Routines cloud tự động, hoặc (b) Pro $20 chạy local cron + GitHub Actions (Lan hướng dẫn 1-1). Không chọn path nào → không pass mốc hoàn 5M.',
    ...
    lanVoice: 'Tôi đoán anh chị đang lo: "Data CV gửi cloud Anthropic có an toàn không?" Câu hỏi rất hay, rất nên hỏi sớm. Anthropic không train trên data routine của anh chị — bạn bật zero retention là xong. Tuần 9 mình bàn sâu chuyện compliance, lúc đó anh chị yên tâm hơn.',
    outcomes: {
      cam: [
...
Mở ./microsites/candidate-001.html cho tôi xem.`,
      ...
      },
      {
        ...
        xp: 60,
        desc: 'Bot trả lời các câu cơ bản. Câu khó → escalate cho bạn. Bot biết phận của nó, không tự diễn quá đà.',
        sampleType: 'prompt',
...
Test: gửi 3 tin nhắn sample từ 3 "ứng viên" khác nhau → verify bot reply đúng.`,
      ...
      },
      {
        ...
        xp: 50,
        desc: 'Tạo candidate record + activity log có timestamp. Sếp hỏi "ai đang ở vòng nào" → bạn show được.',
        sampleType: 'prompt',
...
Nếu agent trả được → Multi-session setup OK.`,
      ...
      },
      {
        ...
        xp: 70,
        desc: 'Orchestrator: chia task, theo dõi progress, giải quyết khi sub-agent vướng. Nó là cái HR Manager ảo của bạn.',
        sampleType: 'prompt',
