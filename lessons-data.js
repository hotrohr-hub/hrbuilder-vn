...
Đính file FEEDBACK-[ten-dong-nghiep].md vào repo — đây là evidence để Lan chấm.`,
  ...
  4: {
    ...
    prereqWarning: '⚠ Buổi này anh chị cần chọn một trong hai đường: (a) Claude Code Max khoảng trăm đô một tháng để chạy Routines trên mây tự động, hoặc (b) Pro hai chục đô chạy hẹn giờ ngay máy mình (cô Lan kèm một-một). Không chọn đường nào thì không qua được mốc hoàn năm triệu.',
